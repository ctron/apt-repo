...
public final class BinaryPackagePackagesFile extends ControlFile
{
    ...
    public BinaryPackagePackagesFile ( final String input ) throws IOException, ParseException
    {
        parse ( input );
    }

    public BinaryPackagePackagesFile ( final InputStream input ) throws IOException, ParseException
    {
        parse ( input );
    }
